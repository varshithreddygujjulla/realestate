...
function EditPlot() {
    ...
    const fetchPlot = async () => {
      try {
        ...
        setFormData({
          ...
          facing: plot.facing || "",
          area: plot.area || "",
          pricePerSqYard: plot.pricePerSqYard || "",
        ...
        console.log("Error fetching plot:", error);
        setMessage("Failed to load plot details");
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setTimeout(() => navigate(`/plots/${id}`), 1500);
    } catch (error) {
      setMessage(error.response?.data?.message || "Failed to update plot");
    }
  };
    ...
    <div style={styles.page}>
      <div style={styles.container}>
        <div style={styles.card}>
          <h1 style={styles.heading}>Edit Plot</h1>
